...
#define EMBER_AF_GENERATED_EVENT_CODE \
  ...
  extern EmberEventControl deviceManagerEventControl; \
  ...
  extern void processSerialEventHandler(void); \
  extern void scanButtonEventHandler(void); \
  extern void systemTimerEventHandler(void); \
  extern void usart1ScanEventHandler(void); \
...
#define EMBER_AF_GENERATED_EVENTS   \
  ...
  { &deviceManagerEventControl, deviceManagerEventHandler }, \
  ...
  { &processSerialEventControl, processSerialEventHandler }, \
  { &scanButtonEventControl, scanButtonEventHandler }, \
  { &systemTimerEventControl, systemTimerEventHandler }, \
  { &usart1ScanEventControl, usart1ScanEventHandler }, \
...
#define EMBER_AF_GENERATED_EVENT_STRINGS   \
  ...
  "Process serial event control",  \
  "Scan button event control",  \
  "System timer event control",  \
  "Usart1 scan event control",  \
